    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Advanced customer monitoring and KYC verification.</p>
        </div>
      </div>
      <div className="bg-[#1E293B]/60 backdrop-blur-md rounded-xl p-8 border border-slate-700/50 shadow-lg text-center flex flex-col items-center justify-center min-h-[400px]">
        <Users size={64} className="text-[#F59E0B] mb-4 opacity-50" />
        <h2 className="text-xl font-bold text-slate-300">Customer Records Syncing...</h2>
        <p className="text-slate-500 mt-2">Fetching millions of records with AI insights.</p>
      </div>
    </div>
  );
};
